...
```{r}
Ind_NYC_2019_cleaned<-data.frame("neighbourhood_group"= Ind_NYC$Geographic.Identifier, "Indicator"=Ind_NYC$Indicator,"Incidents"=Ind_NYC$FY2019)
...
map<-leaflet(NYC) %>%
  ...
  addCircleMarkers(lng = NYC$longitude, 
                   ...
                   popup = paste0("Price per night: ", as.character(NYC$price), " $",
                                         ...
                                         "<br>","Distance to Times Square: ",as.character(round(NYC$dist.timessquare/1000, digits=1))," km"),
...
map2<-leaflet(NYC) %>%
  ...
  addMarkers(lng=df_exp$longitude, 
             lat=df_exp$latitude, 
              icon= castle, popup = paste0("Price per night: ", as.character(df_cheap$exp), " $",
                                         ...
                                         "<br>","Distance to Times Square: ",as.character(round(df_exp$dist.timessquare/1000, digits=1))," km"),
  ...
  addMarkers(lng=df_cheap$longitude,
             ...
             icon= hovel, popup = paste0("Price per night: ", as.character(df_cheap$price), " $",
                                         ...
                                         "<br>","Distance to Times Square: ",as.character(round(df_cheap$dist.timessquare/1000, digits=1))," km"),
